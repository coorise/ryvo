...
import {
  ...
  get_v1_admin_drivers_driver_id_documents_doc_type_view_url,
...
export const routes: RouteDef[] = [
  ...
  {
    method: "GET",
    path: "/v1/admin/drivers/:driver_id/documents/:doc_type/view-url",
    auth: true,
    permissions: ["drivers:read"],
    handler: get_v1_admin_drivers_driver_id_documents_doc_type_view_url,
  },
  {
    method: "POST",
